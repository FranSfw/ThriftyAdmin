...
<body>
  <div class="grid grid-cols-2 ">
    ...
    <form class="mx-12 content-center" action="validaradmin.php" method="POST">
      ...
      <button class="button" name="accion" value="login" id="button_login">Log in</button>
      <div class="flex my-6">
      ...
      <a href="new_user.php">
        <button class="button mb-6" name="accion" value="create" id="button_new_user">Create New User</button>
      </a>
      <p class="text text-center">Are you an employee? <a class="link hover:underline" href="index.php" id="login_employee">Log In As
          Employee</a></p>
    </form>
