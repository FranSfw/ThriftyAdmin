    ...
    <form class="mx-12 content-center">
      ...
      <div class="relative z-0 w-full my-6 mx-auto group">
        <input type="password" name="pswd" 
          class="input block py-2.5 p-0 w-full bg-transparent border-2 rounded-lg border-[#727782] appearance-none focus:outline-none focus:ring-0 focus:border-[#0F172A] peer"
          placeholder=" " required />
